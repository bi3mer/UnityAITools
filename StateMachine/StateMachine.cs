...
namespace AITools.StateMachine
{
        ...
        where TTriggerEnum : Enum 
    {
        ...
        /// <summary>
        /// Construct a AITools.StateMachine.
        ...
        /// <summary>
        /// Add a state to the AITools.StateMachine and sets it as the initial State
        /// </summary>
        ...
        public void ActivateTriggerImmediate(TTriggerEnum key)
        {
            Debug.Assert(running,
                "Activating Triggers when the AITools.StateMachine is not running will accomplish nothing");
        ...
        {
            Debug.Assert(running, 
                "Setting boolean values when the AITools.StateMachine is not running will accomplish nothing");
        ...
        /// If restartAITools.StateMachine is set to true then entry state will be entered and the
        /// AITools.StateMachine will have effectively restarted
        /// </summary>
